...
We've created an RShiny application to use our created package name ([lien](https://github.com/Pioterr/nbsisemhp.git)). The application is disponible on shinyapp.io ([lien](https://pmh-naivebayesclassifier.shinyapps.io/appr/)).
